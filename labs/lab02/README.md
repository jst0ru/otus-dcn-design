...
В скрипт [listswitches.py](listswitches.py) из предыдущего задания была добавлена обработка конфигурации ospf. В файл конфигурации [lab2.yaml](lab2.yaml) помимо настроек ip-адресов из предыдущего задания были добавлены настройки ospf. Все настройки однотипные, ниже пример для leaf1:
```
leaf1:
  ip_routing: yes
  ospf: 1
...
Пример для leaf2:
```
leaf2#sho ip ospf neighbor
Neighbor ID     Instance VRF      Pri State                  Dead Time   Address         Interface
10.73.1.100     1        default  0   FULL                   00:00:38    10.73.1.3       Ethernet1
10.73.2.100     1        default  0   FULL                   00:00:33    10.73.2.3       Ethernet2
10.73.3.100     1        default  0   FULL                   00:00:35    10.73.3.3       Ethernet3
leaf2#
leaf2#sho ip route
...
Gateway of last resort is not set
 ...
 O        10.73.0.101/32 [110/30] via 10.73.1.3, Ethernet1
                                  via 10.73.2.3, Ethernet2
                                  via 10.73.3.3, Ethernet3
 C        10.73.0.102/32 is directly connected, Loopback0
 O        10.73.0.103/32 [110/30] via 10.73.1.3, Ethernet1
                                  via 10.73.2.3, Ethernet2
                                  via 10.73.3.3, Ethernet3
 O        10.73.0.104/32 [110/30] via 10.73.1.3, Ethernet1
                                  via 10.73.2.3, Ethernet2
                                  via 10.73.3.3, Ethernet3
 O        10.73.0.105/32 [110/30] via 10.73.1.3, Ethernet1
                                  via 10.73.2.3, Ethernet2
                                  via 10.73.3.3, Ethernet3
 O        10.73.1.0/31 [110/20] via 10.73.1.3, Ethernet1
 C        10.73.1.2/31 is directly connected, Ethernet1
 O        10.73.1.4/31 [110/20] via 10.73.1.3, Ethernet1
 O        10.73.1.6/31 [110/20] via 10.73.1.3, Ethernet1
 O        10.73.1.8/31 [110/20] via 10.73.1.3, Ethernet1
 O        10.73.1.100/32 [110/20] via 10.73.1.3, Ethernet1
 O        10.73.2.0/31 [110/20] via 10.73.2.3, Ethernet2
 C        10.73.2.2/31 is directly connected, Ethernet2
 O        10.73.2.4/31 [110/20] via 10.73.2.3, Ethernet2
 O        10.73.2.6/31 [110/20] via 10.73.2.3, Ethernet2
 O        10.73.2.8/31 [110/20] via 10.73.2.3, Ethernet2
 O        10.73.2.100/32 [110/20] via 10.73.2.3, Ethernet2
 O        10.73.3.0/31 [110/20] via 10.73.3.3, Ethernet3
 C        10.73.3.2/31 is directly connected, Ethernet3
 O        10.73.3.4/31 [110/20] via 10.73.3.3, Ethernet3
 O        10.73.3.6/31 [110/20] via 10.73.3.3, Ethernet3
 O        10.73.3.8/31 [110/20] via 10.73.3.3, Ethernet3
 O        10.73.3.100/32 [110/20] via 10.73.3.3, Ethernet3
...
## Проверка перестроения маршрутизации при сбоях
Отключим spine1. Сразу после отключения наблюдаем так же потерю связности leaf1 с остальными leaf:
| src \ dst | spine1 | spine2 | spine3 | leaf1 | leaf2 | leaf3 | leaf4 | leaf5 |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| spine1 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| spine2 | FAIL | 0.07 ms | 17.05 ms | 6.32 ms | 6.83 ms | 5.48 ms | 5.79 ms | 10.93 ms |
| spine3 | FAIL | 16.87 ms | 0.07 ms | 6.17 ms | 6.08 ms | 6.38 ms | 7.96 ms | 6.74 ms |
| leaf1 | FAIL | 6.79 ms | 8.80 ms | 0.04 ms | FAIL | FAIL | FAIL | FAIL |
| leaf2 | FAIL | 9.85 ms | 5.82 ms | FAIL | 0.18 ms | 11.91 ms | 20.24 ms | 12.63 ms |
| leaf3 | FAIL | 4.24 ms | 4.63 ms | 9.05 ms | 9.70 ms | 0.03 ms | 8.53 ms | 12.47 ms |
| leaf4 | FAIL | 4.35 ms | 4.18 ms | 10.27 ms | 8.85 ms | 8.68 ms | 0.04 ms | 9.44 ms |
| leaf5 | FAIL | 4.64 ms | 7.85 ms | 12.70 ms | 8.29 ms | 10.92 ms | 9.06 ms | 0.03 ms |

Через небольшое время связность восстанавливается:
| src \ dst | spine2 | spine3 | leaf1 | leaf2 | leaf3 | leaf4 | leaf5 |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| spine2 | 0.10 ms | 8.87 ms | 4.46 ms | 4.89 ms | 4.19 ms | 4.46 ms | 4.16 ms |
| spine3 | 11.01 ms | 0.07 ms | 4.32 ms | 4.12 ms | 4.42 ms | 4.25 ms | 4.90 ms |
| leaf1 | 4.41 ms | 4.45 ms | 0.05 ms | 9.26 ms | 14.61 ms | 11.00 ms | 8.73 ms |
| leaf2 | 4.49 ms | 4.78 ms | 8.95 ms | 0.05 ms | 11.22 ms | 9.56 ms | 9.25 ms |
| leaf3 | 4.41 ms | 4.56 ms | 8.46 ms | 8.96 ms | 0.06 ms | 9.20 ms | 8.96 ms |
| leaf4 | 4.32 ms | 4.32 ms | 9.92 ms | 10.16 ms | 9.58 ms | 0.06 ms | 11.64 ms |
| leaf5 | 4.70 ms | 4.15 ms | 9.72 ms | 12.75 ms | 10.04 ms | 21.62 ms | 0.05 ms |
